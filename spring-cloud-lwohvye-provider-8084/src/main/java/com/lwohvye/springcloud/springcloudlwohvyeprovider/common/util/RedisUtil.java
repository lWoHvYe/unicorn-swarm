...
public class RedisUtil {
     ...
     * @param value 项
     */
    public boolean setHash(String key, Map<String, ?> value, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, value);
            if (time > 0)
                expire(key, time);
     ...
     */
    public boolean deleteHash(String key, Object... item) {
        try {
     ...
     * @param time  过期时间
     */
    public boolean setSet(String key, Set<?> value, long time) {
        try {
            redisTemplate.opsForSet().add(key, value);
            if (time > 0)
                expire(key, time);
    ...
    public long removeSet(String key, Object... values) {
        try {
            var count = redisTemplate.opsForSet().remove(key, values);
            return count;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
     ...
     * @param value 项
     */
    public boolean setListHead(String key, List<?> value) {
        try {
    ...
    /**
     * 将list放入缓存并设置过期时间，放头部
     *
     * @param key   键
     * @param value 项
     * @param time  过期时间
     */
    public boolean setListHead(String key, List<?> value, long time) {
        try {
            redisTemplate.opsForList().leftPush(key, value);
            if (time > 0)
                expire(key, time);
     ...
     * @return
     */
    public boolean setListEnd(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean setListEnd(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0)
                expire(key, time);
     ...
     * @return
     */
    public boolean setListEnd(String key, List<Object> value) {
        try {
     ...
     * @return
     */
    public boolean setListEnd(String key, List<Object> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0)
                expire(key, time);
