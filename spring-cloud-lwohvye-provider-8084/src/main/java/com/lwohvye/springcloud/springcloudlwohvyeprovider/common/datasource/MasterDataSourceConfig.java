 ...
 */
@Configuration
@MapperScan(basePackages = {"com.lwohvye.springcloud.springcloudlwohvyeprovider.dao.master"}, sqlSessionTemplateRef = "masterSqlSessionTemplate")
public class MasterDataSourceConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("masterDataSource") DataSource dataSource)
        ...
        factoryBean.setMapperLocations(
                new PathMatchingResourcePatternResolver().getResources(Objects.requireNonNull(env.getProperty("mybatis.master.mapper-locations"))));
        // 配置数据库下划线转驼峰命名
